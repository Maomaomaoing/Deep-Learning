...
#		 print(img.shape)
		...
		img = tf.layers.dense(img, 8192, activation = "relu", kernel_initializer = self.initial, bias_initializer=tf.zeros_initializer())
		...
		img = tf.layers.dense(img, 32, activation = "relu", kernel_initializer = self.initial, bias_initializer=tf.zeros_initializer())
...
with tf.Session() as sess:
	...
	save_path = saver.save(sess, "model_k3fc4.ckpt")
	
""" save file """
save_json(train_acc, "train_acc_k3fc4.json")
save_json(train_loss, "train_loss_k3fc4.json")

save_json(test_acc, "test_acc_k3fc4.json")
save_json(test_loss, "test_loss_k3fc4.json")
