...
with tf.Session() as sess:
	...
	for epoch in range(n_epoch):
		...
		if epoch % 1 == 0:
			...
			test_acc.append(batch_acc/n2_batch); test_loss.append(loss)
		save_json(predicts, "predicts_"+str(epoch)+".json")
	save_path = saver.save(sess, "model_k3.ckpt")
	
""" save file """
save_json(train_acc, "train_acc_k3.json")
save_json(train_loss, "train_loss_k3.json")

save_json(test_acc, "test_acc_k3.json")
save_json(test_loss, "test_loss_k3.json")
