...
with tf.Session() as sess:
	...
	save_path = saver.save(sess, "model_pre.ckpt")
	
""" save file """
save_json(train_acc, "train_acc_pre.json")
save_json(train_loss, "train_loss_pre.json")

save_json(test_acc, "test_acc_pre.json")
save_json(test_loss, "test_loss_pre.json")
